...
public class CustomerTest {
  ...
  public void shouldHaveRegularRentalStatementWithRegularRentals() {
    ...
    c.addProduct(RentalFactory.createMovie("M1", 1, MovieType.REGULAR));
  ...
  public void shouldHaveRegularRentalStatementWithLongRegularRentals() {
    ...
    c.addProduct(RentalFactory.createMovie("M1", 3, MovieType.REGULAR));
  ...
  public void shouldHaveNewReleaseRentalStatementWithNewReleaseRentals() {
    ...
    c.addProduct(RentalFactory.createMovie("M1", 1, MovieType.NEW_RELEASE));
  ...
  public void shouldAddExtraFrequentRenterPointsForNewReleaseRentalStatementWithForLongNewReleaseRentals() {
    ...
    c.addProduct(RentalFactory.createMovie("M1", 3, MovieType.NEW_RELEASE));
  ...
  public void shouldHaveChildrenRentalStatementWithChildrenRentals() {
    ...
    c.addProduct(RentalFactory.createMovie("M1", 1, MovieType.CHILDRENS));
  ...
  public void shouldHaveChildrenRentalStatementWithLongChildrenRentals() {
    ...
    c.addProduct(RentalFactory.createMovie("M1", 4, MovieType.CHILDRENS));
  ...
  public void shouldAddMultipleMovieRentalToStatement() {
    ...
    c.addProduct(RentalFactory.createMovie("M1", 4, MovieType.REGULAR));
    c.addProduct(RentalFactory.createMovie("M2", 5, MovieType.NEW_RELEASE));
    c.addProduct(RentalFactory.createMovie("M3", 6, MovieType.CHILDRENS));
    c.addProduct(RentalFactory.createMovie("M4", 7, MovieType.NEW_RELEASE));
  ...
  public void shouldHaveDoubleFrequentalPointsForMultipleNewReleasesAndAgeBetween18and22() {
    Customer c = new Customer("Rajesh", 21);
    c.addProduct(RentalFactory.createMovie("M1", 4, MovieType.NEW_RELEASE));
    String expected = "Rental Record for Rajesh\n" + "\tM1\t12.0\n" + "Amount owed is 12.0\n"
        + "You earned 4 frequent renter points";
    String actual = c.getTextStatement();
    assertEquals(expected, actual);
    c.addProduct(RentalFactory.createMovie("M2", 4, MovieType.NEW_RELEASE));
  ...
  public void shouldReduceTheRentaToHalf() {
    ...
    String actual = c.getTextStatement();
    assertEquals(expected, actual);
    c.addCoupons(new ArrayList<CouponType>(List.of(CouponType.FIFTY_PERCENT_OFF)));
    String expectedFinal = "Rental Record for Rajesh\n" + "\tM1\t12.0\n" + "\tM2\t12.0\n" + "\t50% off\t-12.0\n"
        + "Amount owed is 12.0\n"
        + "You earned 8 frequent renter points";
    String actualFinal = c.getTextStatement();
  ...
  public void shouldReduceTheRentaByTenDollarsIfTheTotalPriceIsMoreThanFifty() {
    Customer c = new Customer("Rajesh", 21);
    c.addProduct(RentalFactory.createMovie("M1", 24, MovieType.NEW_RELEASE));
    c.addProduct(RentalFactory.createMovie("M2", 24, MovieType.NEW_RELEASE));
    String expected = "Rental Record for Rajesh\n" + "\tM1\t72.0\n" + "\tM2\t72.0\n" + "Amount owed is 144.0\n"
        + "You earned 8 frequent renter points";
    String actual = c.getTextStatement();
    assertEquals(expected, actual);
    c.addCoupons(new ArrayList<CouponType>(List.of(CouponType.FIFTY_PERCENT_OFF, CouponType.TEN_OFF_ON_FIFTY_OR_MORE_COUPON)));
    String expectedFinal = "Rental Record for Rajesh\n" + "\tM1\t72.0\n" + "\tM2\t72.0\n" + "\t50% off\t-72.0\n"
        + "\t$10 off\t-10.0\n"
        + "Amount owed is 62.0\n"
        + "You earned 8 frequent renter points";
